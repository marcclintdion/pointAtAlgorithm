							 ...
							 LPARAM lParam )
{
    switch( msg )
	{
		...
		case WM_SIZE:
		{
			...
			glLoadIdentity();
			gluPerspective( 45.0, (GLdouble)nWidth / (GLdouble)nHeight, 0.001, 100.0);
		}
		break;
...
// Desc: 
//-----------------------------------------------------------------------------
GLfloat ship_1_y        = 0.0;
GLfloat ship_1_angle	= 0.0;
GLfloat ship_2_y	    = 0.0;
GLfloat up_two	        = 0.0;
GLfloat ship_2_angle    = 0.0;
GLfloat up			    = 0.0;
...
ofstream outSettings("mathTest.cpp");
//------------------------------------------------------------------------------
        outSettings << "ship_1_angle    =  " <<  ship_1_angle   <<  ";\n"; 
